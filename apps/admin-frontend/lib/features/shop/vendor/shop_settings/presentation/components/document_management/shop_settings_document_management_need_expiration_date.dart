...
class ShopSettingsDocumentManagementNeedExpirationDate extends StatelessWidget {
  const ShopSettingsDocumentManagementNeedExpirationDate({
    super.key,
    required this.index,
  });
          ...
          children: [
            ...
            Expanded(
              child: Row(
                ...
                children: [
                  Switch(
                    value: state.shopDocuments[index].hasExpiryDate,
                    onChanged: (value) {
