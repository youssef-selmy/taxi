...
class ShopOrderDetailShopComplaints extends StatelessWidget {
  const ShopOrderDetailShopComplaints({super.key});
        ...
        return Skeletonizer(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(context.tr.shop, style: context.textTheme.headlineSmall),
                const SizedBox(height: 32),
                Column(
                  children:
                      (state.shopOrderComplaintsState.isLoading
                              ? mockShopOrderSupportRequests
                              : complaintsShop!.nodes)
                          .map((complaint) {
                            return Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    child: Text(
                                      complaint.createdAt.formatDateTime,
                                      style: context.textTheme.labelMedium,
                                    ),
                                  ),
