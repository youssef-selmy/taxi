...
class ConfirmAutomaticPayoutDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => ShopPayoutSessionDetailBloc(),
      child:
          BlocBuilder<
            ...
            builder: (context, state) {
              return AppResponsiveDialog(
                ...
                primaryButton: AppFilledButton(
                  ...
                  onPressed: () {
                    context.read<ShopPayoutSessionDetailBloc>().runAutoPayout();
                  },
                ),
                ...
                title: context.tr.pleaseReviewInformationAndConfirm,
                subtitle: context.tr.payout,
                child: Column(
                  children: [
