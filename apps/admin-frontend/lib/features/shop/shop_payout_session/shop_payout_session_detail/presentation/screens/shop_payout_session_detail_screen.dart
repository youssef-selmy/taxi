...
import 'package:admin_frontend/features/shop/shop_payout_session/shop_payout_session_detail/presentation/components/driver_payout_session_detail_transactions.dart';
import 'package:admin_frontend/features/shop/shop_payout_session/shop_payout_session_detail/presentation/components/payout_method_tab_item.dart';
import 'package:admin_frontend/features/shop/shop_payout_session/shop_payout_session_detail/presentation/components/payout_session_payout_method_detail/payout_method_detail.dart';
import 'package:better_icons/better_icons.dart';
import 'package:admin_frontend/schema.graphql.dart';

@RoutePage()
class ShopPayoutSessionDetailScreen extends StatelessWidget {
  final String? payoutSessionId;

  const ShopPayoutSessionDetailScreen({
    super.key,
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          ShopPayoutSessionDetailBloc()..onStarted(id: payoutSessionId!),
                  ...
                  return switch (state.payoutSessionDetailState) {
                    ApiResponseLoaded() || ApiResponseInitial() => Column(
                      ...
                      children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        InfoTile(
                                          ...
                                          data: session?.shopsCount.toString(),
                                        ),
                                  ...
                                  children: [
                                    ...
                                    Flex(
                                      ...
                                      children: [
                                        ...
                                        (session?.shopsPaid ?? 0).toCurrency(
                                          context,
                                          session?.currency ??
                                              Env.defaultCurrency,
                                        ),
                                    ...
                                    Flex(
                                      ...
                                      children: [
                                        ...
                                        (session?.shopsPending ?? 0).toCurrency(
                                          context,
                                          session?.currency ??
                                              Env.defaultCurrency,
                                        ),
                        ...
                        const SizedBox(
                          height: 400,
                          child: ShopPayoutSessionDetailTransactions(),
                        ),
