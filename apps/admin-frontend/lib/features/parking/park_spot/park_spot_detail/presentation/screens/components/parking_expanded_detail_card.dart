...
class ParkingExpandedDetailCard extends StatelessWidget {
  final Fragment$parkSpotDetail item;
  final Fragment$Place? selectedDestination;

  const ParkingExpandedDetailCard({
    super.key,
    required this.item,
                    ...
                    children: [
                      ...
                      if ((item.ratingAggregate.reviewCount) > 0) ...[
                        ParkingFacilityView(
                          ...
                          title:
                              "${item.ratingAggregate.rating}% (${item.ratingAggregate.reviewCount} ${context.tr.reviews})",
