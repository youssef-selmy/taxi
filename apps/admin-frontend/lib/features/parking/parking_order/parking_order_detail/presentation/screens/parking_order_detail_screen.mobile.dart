...
class ParkingOrderDetailScreenMobile extends StatefulWidget {
  const ParkingOrderDetailScreenMobile({
    super.key,
  ...
  @override
  State<ParkingOrderDetailScreenMobile> createState() =>
      _ParkingOrderDetailScreenMobileState();
}

class _ParkingOrderDetailScreenMobileState
    extends State<ParkingOrderDetailScreenMobile>
                    ...
                    children: <Widget>[
                      LayoutGrid(
                        ...
                        children: const <Widget>[
                          ParkingOrderDetailHistories(),
                          ParkingOrderDetailBookingDetail(),
                        ],
                      ),
                      const SizedBox(height: 16),
