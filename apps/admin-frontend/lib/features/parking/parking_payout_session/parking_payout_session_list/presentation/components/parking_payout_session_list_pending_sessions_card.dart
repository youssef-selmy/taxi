...
class ParkingPayoutSessionListPendingSessionsCard extends StatelessWidget {
  const ParkingPayoutSessionListPendingSessionsCard({super.key});
              ...
              child: Column(
                ...
                children: [
                      ...
                      Expanded(
                        child:
                            state
                                ...
                                .nodes
                                .map(
                                  (transaction) => transaction.customer.media,
                                )
                                .nonNulls
                                .toList()
                                .avatarsView(
                  ...
                  AppFilledButton(
                    ...
                    onPressed: () {
                      context.router.push(
                        ParkingPayoutSessionDetailRoute(
                          payoutSessionId:
