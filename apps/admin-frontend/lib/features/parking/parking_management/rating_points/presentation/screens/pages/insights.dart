...
import 'package:admin_frontend/features/parking/parking_management/rating_points/data/repositories/rating_point_insights_repository.mock.dart';
import 'package:admin_frontend/features/parking/parking_management/rating_points/presentation/blocs/rating_points_insights.cubit.dart';
...
class RatingPointsInsights extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => RatingPointsInsightsBloc()..onStarted(),
