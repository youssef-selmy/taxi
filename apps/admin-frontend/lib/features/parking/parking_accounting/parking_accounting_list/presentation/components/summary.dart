...
class ParkingAccountingListSummary extends StatelessWidget {
  const ParkingAccountingListSummary({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<ParkingAccountingListBloc, ParkingAccountingListState>(
