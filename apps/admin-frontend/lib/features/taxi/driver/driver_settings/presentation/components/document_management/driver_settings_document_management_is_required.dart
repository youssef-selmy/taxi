...
class DriverSettingsDocumentManagementIsRequired extends StatelessWidget {
  const DriverSettingsDocumentManagementIsRequired({
    super.key,
    required this.index,
  });
          ...
          children: [
            ...
            Expanded(
              child: Row(
                ...
                children: [
                  Switch(
                    value: state.driverDocuments[index].isRequired,
                    onChanged: (value) {
