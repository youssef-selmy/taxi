...
import 'package:admin_frontend/features/taxi/driver_payout_session/driver_payout_session_detail/presentation/components/driver_payout_session_detail_transactions.dart';
import 'package:admin_frontend/features/taxi/driver_payout_session/driver_payout_session_detail/presentation/components/payout_method_tab_item.dart';
import 'package:admin_frontend/features/taxi/driver_payout_session/driver_payout_session_detail/presentation/components/payout_session_payout_method_detail/payout_method_detail.dart';
import 'package:better_icons/better_icons.dart';
import 'package:admin_frontend/schema.graphql.dart';

@RoutePage()
class DriverPayoutSessionDetailScreen extends StatelessWidget {
  final String? payoutSessionId;

  const DriverPayoutSessionDetailScreen({
    super.key,
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          DriverPayoutSessionDetailBloc()..onStarted(id: payoutSessionId!),
                  ...
                  return switch (state.payoutSessionDetailState) {
                    ApiResponseLoaded() || ApiResponseInitial() => Column(
                      ...
                      children: [
                                  ...
                                  children: [
                                    ...
                                    Flex(
                                      ...
                                      children: [
                                        ...
                                        (session?.totalPaid ?? 0).toCurrency(
                                          context,
                                          session?.currency ??
                                              Env.defaultCurrency,
                                        ),
                                    ...
                                    Flex(
                                      ...
                                      children: [
                                        ...
                                        (session?.totalPending ?? 0).toCurrency(
                                          context,
                                          session?.currency ??
                                              Env.defaultCurrency,
                                        ),
                        ...
                        const SizedBox(
                          height: 400,
                          child: DriverPayoutSessionDetailTransactions(),
                        ),
