...
import 'package:admin_frontend/features/taxi/driver_payout_session/new_batch_payout_session_dialog/presentation/blocs/new_batch_payout_session_dialog.cubit.dart';
import 'package:better_icons/better_icons.dart';
import 'package:admin_frontend/schema.graphql.dart';

class NewBatchPayoutSessionDialog extends StatefulWidget {
  final Enum$AppType appType;

  const NewBatchPayoutSessionDialog({super.key, required this.appType});

  @override
  createState() => _NewBatchPayoutSessionDialogState();
}

class _NewBatchPayoutSessionDialogState
    extends State<NewBatchPayoutSessionDialog> {
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          NewBatchPayoutSessionDialogBloc()..onStarted(appType: widget.appType),
                    ...
                    children: [
                      ...
                      AppTextField(
                        ...
                        onChanged: (value) => context
                            .read<NewBatchPayoutSessionDialogBloc>()
                            .onMinimumAmountChanged(double.parse(value)),
                        label: context.tr.minimumAmount,
                        hint: context.tr.enterMinimumPayoutWalletBalance,
