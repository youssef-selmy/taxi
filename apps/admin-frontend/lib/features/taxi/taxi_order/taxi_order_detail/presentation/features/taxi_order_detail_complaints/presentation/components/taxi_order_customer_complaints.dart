...
class TaxiOrderCusromerComplaints extends StatelessWidget {
  const TaxiOrderCusromerComplaints({super.key});
                ...
                ListView.separated(
                  ...
                  itemCount: state.complaintState.isLoading
                      ...
                      : complaints?.taxiOrderSupportRequests.nodes
                                .where((e) => e.requestedByDriver == false)
                                .toList()
                                .length ??
                            0,
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Row(
                            ...
                            children: [complaint.status.chip(context)],
                          ),
                          const SizedBox(width: 24),
                          AppTextButton(
