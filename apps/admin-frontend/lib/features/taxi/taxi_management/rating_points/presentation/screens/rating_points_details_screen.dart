...
@RoutePage()
class TaxiRatingPointsDetailsScreen extends StatelessWidget {
  final String? ratingPointId;

  TaxiRatingPointsDetailsScreen({
    super.key,
    @QueryParam('ratingPointId') this.ratingPointId,
  });
