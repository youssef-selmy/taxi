...
class AppEcommerceList extends StatelessWidget {
  const AppEcommerceList({super.key});
            ...
            children: [
                    ...
                    child: better_assets
                        ...
                        .svg(
                          ...
                          colorFilter: ColorFilter.mode(
                            context.colors.onInsight,
                            BlendMode.srcIn,
                          ),
                        ),
                  ),
                  const SizedBox(width: 8),
                  Text('E-Commerce', style: context.textTheme.titleMedium),
                  const Spacer(),
                  AppTextButton(
                    onPressed: () {
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Flexible(
                      child: Assets.images.showcase.ecommerceDashboard.image(),
                    ),
                    if (!context.isMobile) ...[
                      const SizedBox(width: 8),
                      Flexible(
                        child:
                            Assets.images.showcase.ecommerceProductsList
                                .image(),
                      ),
                    ],
                  ],
