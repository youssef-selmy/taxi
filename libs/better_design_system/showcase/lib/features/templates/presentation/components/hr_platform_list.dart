...
class AppHrPlatformList extends StatelessWidget {
  const AppHrPlatformList({super.key});
            ...
            children: [
              Row(
                children: [
                  Container(
                    ...
                    child: better_assets.Assets.images.iconsTwotone.userSquare
                        .svg(
                          width: 20,
                          height: 20,
                          colorFilter: ColorFilter.mode(
                            context.colors.onInfo,
                            BlendMode.srcIn,
                          ),
                        ),
                  ),
                  const SizedBox(width: 8),
                  Text('HR Platform', style: context.textTheme.titleMedium),
                  const Spacer(),
                  AppTextButton(
                    onPressed: () {
                      context.router.push(const HrPlatformRoute());
                    },
                    text: 'View Template',
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Flexible(
                      child: Assets.images.showcase.hrPlatformDashboard.image(),
                    ),
                    if (!context.isMobile) ...[
                      const SizedBox(width: 16),
                      Flexible(
                        child: Assets.images.showcase.hrPlatformKanban.image(),
                      ),
                    ],
                  ],
                ),
