...
class AppFintechList extends StatelessWidget {
  const AppFintechList({super.key});
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: better_assets.Assets.images.iconsTwotone.bank.svg(
                      width: 20,
                      height: 20,
                  ...
                  Text('Fintech', style: context.textTheme.titleMedium),
                  const Spacer(),
                  AppTextButton(
                    onPressed: () {
                      context.router.push(const FintechRoute());
                    },
                    text: 'View Template',
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Flexible(
                      child:
                          Assets.images.showcase.fintechFirstDashboard.image(),
                    ),
                    if (!context.isMobile) ...[
                      const SizedBox(width: 16),
                      Flexible(
                        child:
                            Assets.images.showcase.fintechSecondDashboard
                                .image(),
                      ),
                    ],
                  ],
