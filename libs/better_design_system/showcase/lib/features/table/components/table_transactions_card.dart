import 'package:better_design_showcase/features/table/components/table_transactions_data.dart';
...
class TableTransactionsCard extends StatelessWidget {
  const TableTransactionsCard({super.key});
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Transactions that has been applied by users.',
