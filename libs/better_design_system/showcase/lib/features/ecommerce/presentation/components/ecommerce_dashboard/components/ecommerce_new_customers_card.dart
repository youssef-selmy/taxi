...
class EcommerceNewCustomersCard extends StatelessWidget {
  const EcommerceNewCustomersCard({super.key});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(BetterIcons.userAdd01Outline, size: 24),
                ...
                SizedBox(
                  ...
                  child: AppDropdownField.single(
                    ...
                    items: [AppDropdownItem(value: 'Weekly', title: 'Weekly')],
                    initialValue: 'Weekly',
                    isFilled: false,
                  ),
                ),
  ...
  Widget _buildLineChart(BuildContext context) {
    return SizedBox(height: 275, child: LineChart(_lineChartData(context)));
  }
                ...
                (spot, percent, barData, index) =>
                    index == barData.spots.length - 1
                        ...
                        : FlDotCirclePainter(
                          ...
                          strokeWidth: 0,
                          strokeColor: context.colors.surface.withValues(
                            alpha: 0,
                          ),
                        ),
          ),
