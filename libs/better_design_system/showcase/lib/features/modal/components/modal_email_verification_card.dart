...
class ModalEmailVerificationCard extends StatelessWidget {
  const ModalEmailVerificationCard({super.key});
        ...
        children: [
          ...
          Padding(
            ...
            child: AppTextField(
              ...
              isFilled: false,
              prefixIcon: const Icon(BetterIcons.mail02Outline, size: 20),
