...
class SalesAndMarketingRefundsSalesSummaryCard extends StatefulWidget {
  final bool isMobile;
  const SalesAndMarketingRefundsSalesSummaryCard({
    super.key,
    this.isMobile = false,
  });

  @override
  State<SalesAndMarketingRefundsSalesSummaryCard> createState() =>
      _SalesAndMarketingRefundsSalesSummaryCardState();
}

class _SalesAndMarketingRefundsSalesSummaryCardState
    extends State<SalesAndMarketingRefundsSalesSummaryCard> {
