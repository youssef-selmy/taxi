...
import '../components/sales_and_marketing_refunds_sales_summary_card.dart';
import '../components/salse_and_marketing_refunds_sales_order_summary.dart';

class SalesAndMarketingDashboardRefundsScreenMobile extends StatefulWidget {
  const SalesAndMarketingDashboardRefundsScreenMobile({super.key});

  @override
  State<SalesAndMarketingDashboardRefundsScreenMobile> createState() =>
      _SalesAndMarketingDashboardRefundsScreenMobileState();
}

class _SalesAndMarketingDashboardRefundsScreenMobileState
    extends State<SalesAndMarketingDashboardRefundsScreenMobile> {
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: SalesAndMarketingDashboardNavbarSecondary(
                  isMobile: true,
                  title: Text('Refunds', style: context.textTheme.titleMedium),
                ),
              ),
              // Main content
              SizedBox(height: 8),
              Column(
                ...
                children: [
                  ...
                  SalseAndMarketingRefundsSalesOrderSummary(isMobile: true),
                  SalesAndMarketingRefundsReasonRefundStaticsCard(
                    isMobile: true,
                  ),
                  SalesAndMarketingRefundsSalesSummaryCard(isMobile: true),
