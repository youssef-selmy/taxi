...
final sunburstYellowLightColorScheme = ColorSystem(
  ...
  // Primary colors
  primary: ColorPalette.sunburstYellow500,
  primaryBold: ColorPalette.sunburstYellow700,
  primaryVariant: ColorPalette.sunburstYellow100,
  primaryVariantLow: ColorPalette.sunburstYellow50,
  primaryContainer: ColorPalette.sunburstYellow12Percent,
  primaryDisabled: ColorPalette.sunburstYellow48Percent,
  onPrimary: ColorPalette.blackMain,

  // Secondary colors
  secondary: ColorPalette.orange500,
  secondaryBold: ColorPalette.orange700,
  secondaryVariant: ColorPalette.orange100,
  secondaryVariantLow: ColorPalette.orange50,
  secondaryContainer: ColorPalette.orange12Percent,
  secondaryDisabled: ColorPalette.orange32Percent,
  ...
  betterTheme: BetterThemes.sunburstYellow,
);
